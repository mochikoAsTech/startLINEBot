...
APIにリクエストを投げることを「APIをたたく」と表現することがあります。キーボードのEnterキーを「ッッッターン！」とたたいてAPIを実行するイメージから来ているのか、あるいはAPIのドアをコンコンとたたいて「すみません、お天気情報が欲しいんですが…」と訪問するイメージなのか、由来は筆者も分かりませんが、「APIをたたく」という言葉はエンジニア界隈では割と広く使われている印象です。
