...
［Verify your phone number］と表示されたら、携帯電話の電話番号を入力します。プラス記号と国番号の81からはじまる国際的な電話番号の形式なので、あなたの電話番号が「080-1234-5678」なら「8012345678」と入力してください。入力したら［Send code］をクリックします。（@<img>{openai-account-6}）
