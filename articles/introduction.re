 ...
 * LINE APIを使ってみたい人
 * LINEでBotを作ってみたい人
 この部分だけ（？）、一般名詞としてのボットがBotと表記されている（ほかはカタカナ表記）
...
「LINEってやってる？」「うん。でも家族としか使ってない」というときのLINEは、コミュニケーションアプリとしてのLINEアプリのことを指しています。「昨日送ったLINE見た？」「ごめん。寝てた」というときのLINEは、LINEアプリのトーク上でやりとりするメッセージのことを指しています。「LINEの本社ってどこにあるんだろう？」「そうなんだ」というときのLINEは、LINE株式会社のことを指しています。
