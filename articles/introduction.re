...
ブラウザで真っ白い背景に黒字でHello World!と表示されただけでも「自分が作ったものがいつも使っているブラウザで動いたー！」という喜びでいっぱいになるのに、それが「自分が作ったものがいつも使っているLINEというアプリで動いた！」になるとますます嬉しいので、筆者ははじめてプログラミングをするならLINE Botを作るのがいいんじゃないかな、と思っています。無料ではじめられるし、たぶんあなたが思ってるより少ない手順であっさり動きます。それでいて色々こだわろうと思ったら色んな奥深い機能があって飽きないし、コミュニティも活発なので質問や相談もしやすいです。
 ...
 * LINE APIを使ってみたい人
 * LINEでボットを作ってみたい人
 * LINE公式アカウントの運用をしているけどMessaging APIは使ったことがない人
