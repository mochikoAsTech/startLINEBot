...
//image[send-message-via-app][［追加］から［テキスト］を選んでテキストを入力する][scale=0.4]{
//}

さらに［追加］をタップして、今度は［スタンプ］を選び、［スタンプを選択］から適当なスタンプを選びます。（@<img>{send-message-via-app-2}）

//image[send-message-via-app-2][［追加］して適当なスタンプを選択する][scale=0.4]{
//}
...
//image[preview-message-2][トークルームやトークリストでの見え方が送信前に確認できる][scale=0.4]{
//}
