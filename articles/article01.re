...
=== LINE公式アカウントにメッセージを送ってみる

LINE公式アカウントに「絶対に新刊買ってね！」と圧をかけられたので、ここで「新刊買います！」と返事をしたらいったいどうなるのでしょうか？物は試しです。メッセージを送ってみましょう。
...
認証済アカウントになると、バッジの色が灰色から青色になってついて「公式っぽさ」が増すと共に、LINE内でアカウント名や概要が検索対象@<fn>{account-name}になり、検索結果に表示されるようになります。@<fn>{search}逆に言えば、デフォルトの未認証アカウントであれば、友だち追加のQRコードや、ベーシックID、あるいはプレミアムIDを自ら流出させない限り、知らない人が勝手に友だち追加される可能性は低いということです。
