...
//image[select-icon][右上にある人型のアイコンをタップ][scale=0.6]{
//}

そして［自分の公式アカウント］の下にある［公式アカウント作成・連携］というボタンをタップします。（@<img>{create-oa}）

//image[create-oa][［公式アカウント作成・連携］をタップ][scale=0.6]{
//}
...
//image[regist-mail-address][メールアドレスが未登録だった場合は［登録］をタップ][scale=0.6]{
//}

LINEアカウントに登録するメールアドレスを入力して、［次へ］をタップしてください。（@<img>{regist-mail-address-2}）

//image[regist-mail-address-2][メールアドレスを入力して［次へ］をタップ][scale=0.6]{
//}
...
LINEに戻って、Keepメモという自分専用トークルームみたいなところに友だち追加URLをペーストします。元気よく「友だち募集中」と表示されました。タップして友だちになってみましょう。（@<img>{add-friends-2}）
