...
LINE公式アカウントからメッセージで「絶対に新刊買ってね！」と圧をかけられたので、ここで「新刊買います！」と返事をしてあげたいのですが、LINE公式アカウントに返事を送ったらいったいどうなるのでしょうか？物は試しです。メッセージを送ってみましょう。
...
プレミアムIDと有料プランは別枠なので、無料のコミュニケーションプランのまま、プレミアムIDだけ購入することも可能です。またプレミアムIDを取得しても、ベーシックIDや、過去に作った友だち追加のURL、QRコードなどは引き続き使用できます。
...
認証済アカウントになると、バッジの色が灰色から青色になってついて「公式っぽさ」が増すと共に、LINE内でアカウント名や概要が検索対象@<fn>{account-name}になり、検索結果に表示されるようになります。@<fn>{search}逆に言えば、デフォルトの未認証アカウントであれば、友だち追加のQRコードや、ベーシックID、あるいはプレミアムIDを自ら露出しない限り、知らない人から勝手に友だち追加される可能性は低いということです。
