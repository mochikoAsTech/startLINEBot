...
まずはLINEを開いて、下に並んでいるホーム、トーク、VOOM、ニュース、ウォレットという5つのタブのうち、中央にある［VOOM］タブをタップしてください。（@<img>{select-voom}）
...
2は、1に比べるともう少し凝ったメッセージが作れますが、やはり細かい部分で自由度が低いです。そして3だと自分でコードを書かなければいけないですが、その分かなり自由にメッセージを作り込めます。
...
残念ながら友だちがひとりもいない状態でメッセージを配信してしまったため、折角送ったメッセージですが誰にも届かなかったようです。LINE公式アカウントからメッセージを送って、ちゃんと「友だち」に届くことを確認するため、まずは自分がLINE公式アカウントと友だちになってみましょう。
...
ピロン！LINEの通知が来ました！圧の強いメッセージが届いたようです。やったね！これで「LINE公式アカウントから友だちにメッセージを送る」というアチーブメントを達成しました。（@<img>{got-a-message}）
...
LINE公式アカウントからメッセージで「絶対に新刊買ってね！」と圧をかけられたので、ここで「新刊買います！」と返事をしてあげたいのですが、LINE公式アカウントに返事を送ったらいったいどうなるのでしょうか？物は試しです。LINEで、LINE公式アカウントに対してメッセージを送ってみましょう。
