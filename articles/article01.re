...
//footnote[cannot][LINEでは、LINE公式アカウントを作ることはできても、さすがにLINE公式アカウントからメッセージを送るところまではできません。]
...
では自分のLINEに戻って、メッセージが届いたか確認してみましょう。友だちみんなには届かなくても、少なくともLINE公式アカウントを作った創造主である自分にはメッセージが届いているかな、と思いましたが、残念ながら何も届いていません。メッセージを送信した履歴も残っていません。（@<img>{no-message-received}）
