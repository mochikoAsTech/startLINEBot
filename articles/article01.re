...
VOOMとやらがなんなのかということは、ひとまず考えずに進みましょう。VOOMタブを開くといきなりショート動画が再生されてびびりますが、［フォロー中］を開いた後、右上にある人型のアイコンをタップします。（@<img>{select-icon}）
...
//image[send-message-via-app][［追加］から［テキスト］を選んでテキストを入力する][scale=1]{
//}

さらに［追加］をタップして、今度は［スタンプ］を選び、［スタンプを選択］から適当なスタンプを選びます。（@<img>{send-message-via-app-2}）

//image[send-message-via-app-2][［追加］して適当なスタンプを選択する][scale=1]{
//}
