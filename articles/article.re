...
LINE公式アカウントには、企業や店舗だけでなく、芸能人のものも存在します。たとえば地震のときに誰よりも早く「大丈夫？」とメッセージをくれて、彼氏感がすごい、と話題になったLINE公式アカウントもありました。あまりのプライベートっぽさに、まるで普通にLINEで友だちになったような感覚になりますが、落ち着いてください。あれはLINE公式アカウントです。@<fn>{takeru}
...
たとえば友だちが100人いるLINE公式アカウントから、すべての友だちに一斉送信する形でメッセージを2回送ったら、それだけで200通になりますね。こんなふうにたくさんの友だちにメッセージを継続して送ろうとすると、有料のプランを使う必要がありますが、逆に友だちが自分ひとりだけなら200回送れます。なので本書でちょっと試してみる程度なら無料のフリープランで問題ありません。無料メッセージの通数を使い切れば、次の月初までメッセージが送れなくなるだけで、自分で有料のライトプランやスタンダードプランに申し込まない限りは、メッセージの使いすぎで勝手に課金が始まることはありませんので安心してください。

== LINE公式アカウントを作ってみる

色々説明しましたが、実際に手を動かしてやってみるのが理解への一番の近道です。LINE公式アカウントを作ってみましょう。
...
方法は色々ありますが、注目してほしいのは1番目！そう、なんと専用のアプリや管理画面を使わなくても、お手持ちのスマートフォンに入っているLINEで作れるんです！早速、LINE公式アカウントを作ってみましょう。
...
まずはLINE公式アカウントのプロフィール画像とアカウント名を設定します。アカウント名と言われてもピンとこないかもしれませんが、もしあなたが技術書典に出展しているサークルさんなら、サークルの名前とアイコンを設定して、サークルの宣伝をするLINE公式アカウントにしてもいいかもしれません。あるいは自分のハンドルネームにしてもいいでしょう。このアカウント名はユニークではないため、既存のLINE公式アカウントとかぶる名称であっても付けられます。なおプロフィール画像もアカウント名も後から変更が可能ですので、悩みすぎずに取りあえずの画像や名前を設定しても構いません。（@<img>{setting-oa-1}）

//image[setting-oa-1][プロフィール画像とアカウント名を設定しよう][scale=0.4]{
//}

カテゴリーの大業種は［個人］を選ぶと、小業種に［個人（芸術・創造・執筆）］があります。たとえば自分の本の告知用という位置づけで作るなら、この［個人（芸術・創造・執筆）］という小業種にしますが、他にも［個人（IT・コンピュータ）］や［個人（学生）］、［個人（その他）］などもあるので、個人的に開発を試す用途など、LINE公式アカウントの使い道に応じて適していると思われる業種を選択してください。［会社・事業者の所在国・地域］は、個人の場合は店舗や居住地を選択すればよいので、もしあなたが日本にお住まいなら［日本］を選びます。（@<img>{setting-oa-2}）
...
でも今回やりたいことはLINE VOOMでの動画投稿ではなく、友だち追加してくれた相手に対するメッセージの送信です。LINE公式アカウントから友だちにトークでメッセージが送りたいときはどうすればいいのでしょう？

=== スマートフォンにLINE公式アカウント管理アプリをインストールする

作ったばかりのLINE公式アカウントから友だちにメッセージを送るため、既にLINEを使っているスマートフォンで、LINE公式アカウント管理アプリをインストールします。
